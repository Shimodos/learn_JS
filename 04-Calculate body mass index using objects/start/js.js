...
console.log(petr.bmiRes);
console.log(denis.bmiRes);

if (petr.bmiRes > denis.bmiRes) {
  console.log(
    `Индекс массы тела Петра ${petr.bmiRes}, больше индекса массы тела Дениса ${denis.bmiRes}!`,
  );
} else if (petr.bmiRes < denis.bmiRes) {
  console.log(
    `Индекс массы тела Дениса ${denis.bmiRes}, больше индекса массы тела Петра ${petr.bmiRes}!`,
  );
} else {
  console.log("Индекс массы тела Петра и Дениса равны!");
}
